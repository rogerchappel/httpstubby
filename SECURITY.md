...
Replace this section with the supported versions for `httpstubby`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `httpstubby` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in httpstubby.
